  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button>
          <IoCardOutline className=" text-[#6C7984] w-6 h-6" />
        </button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
        ...
        <form
          className="flex px-5 relative items-center overflow-hidden pb-20  gap-7 flex-wrap xl:flex-nowrap"
          ...
          <div>
            ...
            <div>
              <Image
                src={bankCardImg}
                alt="Image"
                className="max-w-[158px] absolute right-0 top-[140px]"
              />
            </div>
          </div>
        </form>
